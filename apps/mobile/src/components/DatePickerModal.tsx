    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <Pressable style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.45)", justifyContent: "flex-end" }} onPress={onClose}>
        <Pressable
          ...
          style={{ backgroundColor: "#fff", borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: 16, paddingBottom: 20, maxHeight: "86%" }}
        >
          ...
          {yearOpen ? (
            <View style={{ height: 220, borderWidth: 1, borderColor: "#E5E7EB", borderRadius: 12, marginBottom: 12, overflow: "hidden" }}>
            ...
            <>
              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                {cells.map((day, index) => {
                  if (day == null) {
                    return <View key={`empty-${index}`} style={{ width: "14.28%", height: 42 }} />;
                  }
                  ...
                  return (
                    <PressScale
                      ...
                      style={{ width: "14.28%", height: 42, alignItems: "center", justifyContent: "center" }}
                    >
                      <View
                        style={{
                          width: 34,
          ...
          <PressScale
            onPress={confirm}
            style={{ marginTop: 14, height: 48, borderRadius: 12, backgroundColor: GREEN, alignItems: "center", justifyContent: "center" }}
          >
